...
## Test regex
    ...
    def test_tail_n_10_invalid_remove_empty_string_false_keep_when_regex_valid_pass_when_regex_valid_regex_Warning(self):
        n: int = 10
        global headers
        result_to_test: list = file_operations_lib.WithEOL.tail(file=custom_path, n=n, keep_when_regex=True, regex="\[Warning\]:.*", restrict=True)
    ...
    def test_tail_n_10_invalid_remove_empty_string_false_keep_when_regex_valid_pass_when_regex_valid_regex_Info(self):
        n: int = 10
        global headers
        result_to_test: list = file_operations_lib.WithEOL.tail(file=custom_path, n=n, keep_when_regex=True, regex="\[Info\]:.*", restrict=True)
    ...
    def test_tail_n_10_invalid_remove_empty_string_false_keep_when_regex_valid_pass_when_regex_valid_regex_Error(self):
        n: int = 10
        global headers
        result_to_test: list = file_operations_lib.WithEOL.tail(file=custom_path, n=n, keep_when_regex=True, regex="\[Error\]:.*", restrict=True)
