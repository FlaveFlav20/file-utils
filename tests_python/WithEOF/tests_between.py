...
class TestWithEOFBetween(unittest.TestCase):
    def test_between_n1_1_n2_1_valid_remove_empty_string_false(self):
        ...
        self.assertEqual(file_operations_lib.WithEOL.between(path=path, n1=n1, n2=n2, restrict=False), ref)
    ...
    def test_between_n1_neg_n2_pos_invalid_remove_empty_string_false(self):
        ...
        n2: int = 1
        try:
            file_operations_lib.WithEOL.between(path=path, n1=n1, n2=n2, restrict=False)
        except:
            check_pass = False
        if check_pass:
...
## 
    ...
    def test_between_n1_1_n2_1_valid_remove_empty_string_true(self):
        ...
        file.close()
        ref: list = get_list(res)
        self.assertEqual(file_operations_lib.WithEOL.between(path=path, n1=n1, n2=n2, remove_empty_string=True, restrict=False), ref)
    ...
    def test_between_n1_neg_n2_pos_invalid_remove_empty_string_true(self):
        ...
        n2: int = 1
        try:
            file_operations_lib.WithEOL.between(path=path, n1=n1, n2=n2, remove_empty_string=True, restrict=False)
        except:
            check_pass = False
        if check_pass:
            self.fail("[between] Negative value shouldn't work")
