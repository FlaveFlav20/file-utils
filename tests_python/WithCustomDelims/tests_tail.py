...
class TestWithCustomDelimTail(unittest.TestCase):
    def test_tail_n_10_valid_remove_empty_string_false(self):
        ...
        self.assertEqual(file_utils_lib.WithCustomDelims.tail(path=path_delim, n=n, delimiter=delimiter), ref)
    ...
    def test_tail_n_neg_invalid_remove_empty_string_false(self):
        ...
        try:
            file_utils_lib.WithCustomDelims.tail(path=path_delim, n=n)
        except:
            check_pass = False
        if check_pass:
...
## 
    ...
    def test_custom_path_tail_n_10_valid_remove_empty_string_false(self):
        ...
        file.close()
        ref: list = get_list(res)
        self.assertEqual(file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n, delimiter=delimiter), ref)
    ...
    def test_custom_path_tail_n_neg_invalid_remove_empty_string_false(self):
        check_pass: bool = True 
        try:
            file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n)
        except:
            check_pass = False
        if check_pass:
            self.fail("[tail] Negative value shouldn't work")
...
## Test empty lines ----------
    ...
    def test_tail_n_10_valid_remove_empty_string_true(self):
        ...
        file.close()
        ref: list = get_list(res)
        self.assertEqual(file_utils_lib.WithCustomDelims.tail(path=path_delim, n=n, delimiter=delimiter, remove_empty_string=True, restrict=False), ref)
    ...
    def test_tail_n_0_valid_remove_empty_string_true(self):
        ...
        file.close()
        ref: list = get_list(res)
        self.assertEqual(file_utils_lib.WithCustomDelims.tail(path=path_delim, n=n, delimiter=delimiter, remove_empty_string=True), ref)
    ...
    def test_tail_n_neg_invalid_remove_empty_string_true(self):
        check_pass: bool = True 
        try:
            file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n, delimiter=delimiter, remove_empty_string=True)
        except:
            check_pass = False
        if check_pass:
            self.fail("[tail] Negative value shouldn't work")
...
## 
    ...
    def test_custom_path_tail_n_10_valid_remove_empty_string_true(self):
        ...
        file.close()
        ref: list = get_list(res)
        self.assertEqual(file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n, delimiter=delimiter, remove_empty_string=True), ref)
...
## Test regex
    ...
    def test_tail_n_valid_invalid_remove_empty_string_false_keep_when_regex_invalid(self):
        check_pass: bool = True 
        try:
            file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n, delimiter=delimiter, remove_empty_string=True, regex_keep="Haha")
        except:
            check_pass = False
        if check_pass:
    ...
    def test_tail_n_valid_invalid_remove_empty_string_false_keep_when_regex_valid_pass_when_regex_invalid(self):
        check_pass: bool = True 
        try:
            file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n, delimiter=delimiter, remove_empty_string=True, regex_pass="Haha")
        except:
            check_pass = False
        if check_pass:
            self.fail("[tail] Non bool value shouldn't work")
    ...
    def test_tail_n_valid_invalid_remove_empty_string_false_keep_when_regex_valid_pass_when_regex_valid_regex_invalid(self):
        check_pass: bool = True 
        try:
            file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n, delimiter=delimiter, remove_empty_string=True, regex=1)
        except:
            check_pass = False
        if check_pass:
            self.fail("[tail] Non bool value shouldn't work")
    ...
    def test_tail_n_10_invalid_remove_empty_string_false_keep_when_regex_valid_pass_when_regex_valid_regex_Warning(self):
        n: int = 10
        global headers
        print(f"PATHHHH {custom_path_delim}")
        result_to_test: list = file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n, delimiter=delimiter, regex_keep=["\[Warning\]:.*"], restrict=True)
    ...
    def test_tail_n_10_invalid_remove_empty_string_false_keep_when_regex_valid_pass_when_regex_valid_regex_Info(self):
        n: int = 10
        global headers
        result_to_test: list = file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n, delimiter=delimiter, regex_keep=["\[Info\]:.*"], restrict=True)
    ...
    def test_tail_n_10_invalid_remove_empty_string_false_keep_when_regex_valid_pass_when_regex_valid_regex_Error(self):
        n: int = 10
        global headers
        result_to_test: list = file_utils_lib.WithCustomDelims.tail(path=custom_path_delim, n=n, delimiter=delimiter, regex_keep=["\[Error\]:.*"], restrict=True)
